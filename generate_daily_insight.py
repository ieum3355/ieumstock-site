...
def generate_insight():
    ...
    if recommendation:
        ...
        content_body = {
            ...
            "core_analysis": [
                {
                    "sub_heading": "1. 실시간 돌파 감지 (SCANNING) 및 거래량 해석",
                    "text": f"전일 거래량 대비 300% 이상의 대량 거래가 포착되었습니다. 특히 5분 봉상 주요 매물대인 {pick['trading_strategy']['entry_price']:,}원 위에서 안정적인 지지 흐름을 보이고 있으며, 이는 세력이 하방 압력을 이겨내고 상방으로 방향을 틀었다는 강력한 증거입니다.",
                    "insight_tip": f"주요 저항 구역인 {pick['trading_strategy']['target_price']:,}원 돌파 시 거래량 실리는지 확인하십시오.",
                    "icon_type": "analysis"
                },
                {
                    "sub_heading": "2. 메이저 수급 추적 (TRACKING) 및 수급 데이터 해석",
                    "text": f"외국인과 기관의 매수세가 바닥권에서 동시에 유입되는 '쌍끌이' 현상이 나타나고 있습니다. 특히 최근 5거래일간의 누적 수급량이 평소 대비 2.5배 증가하며, 메이저 주체들이 물량을 매집하고 있는 징후가 뚜렷합니다.",
                    "insight_tip": "수급 창구에서의 이탈이 없는지 실시간으로 모니터링하십시오.",
                    "icon_type": "volume"
                },
                {
                    "sub_heading": "3. 기술적 근거: 이평선 역배열 탈출의 미학",
                    "text": f"112일선이라는 거대한 매물벽을 뚫어내는 과정은 세력이 막대한 자금을 투입했다는 확실한 증거입니다. {pick['stock_info']['real_name']}은 캔들의 몸통이 이평선 위에 안착한 후, 다음 거래일에 이평선을 지지선으로 삼아 망치형 캔들을 만드는 '개미 털기' 구간을 통과했습니다.",
                    "insight_tip": "지지선 이탈 여부를 체크하며 보유 전략을 유지하십시오.",
                    "icon_type": "trend"
                },
                {
                    "sub_heading": "4. 변동성 필터링 (VERIFIED) 및 리스크 평가",
                    "text": "시장 노이즈를 제거하고 순수 에너지를 측정한 결과, 변동성 지표가 안정적인 범위 내에 머물고 있습니다. 지수 하락 대비 견조한 주가 흐름을 보여주어, 시장 대비 상대적 강도(RS)가 매우 높게 측정되었습니다.",
                    "insight_tip": f"손절가 {pick['trading_strategy']['stop_loss']:,}원 준수 시 기대 수익률이 높은 구간입니다.",
                    "icon_type": "risk"
                },
                {
                    "sub_heading": "5. 향후 전망 및 대시세 시나리오",
                    "text": "단기적으로는 직전 고점 돌파가 예상되며, 중장기적으로는 업황 개선과 맞물려 강력한 시세 분출이 기대됩니다. 현재 구간은 무릎 이하의 저평가 구간으로, 눌림목 발생 시 비중 확대 전략이 유효합니다.",
                    "insight_tip": "목표가 도달 시 순차적인 익절로 수익을 확정하십시오.",
                    "icon_type": "strategy"
                }
            ],
            "practical_guide": {
