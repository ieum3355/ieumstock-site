...
export const CONTENT_DB: {
  ...
  blog_posts: [
    ...
    },
    {
      ...
      content: "<p>손실을 줄이기 위해 추가 매수하는 '물타기'. 하지만 하락하는 칼날을 잡다가 손실만 키우는 경우가 많습니다. 물타기는 <strong>'내가 틀렸음을 인정할 때'</strong> 하는 것이 아니라, <strong>'시장이 과도하게 공포에 질렸을 때'</strong> 해야 합니다. 기업의 가치는 그대로인데 주가만 빠졌다면, 그때가 바로 기회입니다.</p>"
    },
    {
      id: 7,
      ...
      content: "<p>시장을 이끄는 대장주, 일명 '주도주'를 잡아야 계좌가 불어납니다. 주도주는 차트보다 '시대의 흐름'에서 나옵니다. <h4>1. 모든 사람이 그 기술/제품을 이야기하는가?</h4><p>과거의 스마트폰, 전기차, 그리고 최근의 AI까지. 세상을 바꾸는 혁신이 일어나는 곳에 돈이 몰립니다.</p><h4>2. 실적이 숫자로 찍히기 시작했는가?</h4><p>단순한 기대감이 아니라, 실제로 매출과 영업이익이 폭발적으로 성장하는 시점. 그때가 바로 주가의 본격적인 상승기입니다.</p>"
    },
    {
      id: 6,
      ...
      content: "<p>모두가 주식 시장을 떠날 때가 기회라는 말, 들어보셨죠? 하지만 막상 폭락장이 오면 공포심에 손이 나가지 않습니다. 역사는 반복됩니다. IMF, 리만 브라더스, 코로나 팬데믹... 당시에는 세상이 망할 것 같았지만, 결국 시장은 전고점을 뚫고 올라왔습니다. <div class='highlight-box'><strong>✨ 멘탈 관리 팁</strong><br>시장이 공포에 질려 던질 때, 용기를 내어 '분할 매수'를 시작하세요. 바닥을 맞출 순 없지만, 무릎에서 살 수는 있습니다.</div><p>남들이 공포에 떨 때 욕심을 부리는 자만이 자본주의의 승리자가 될 수 있습니다.</p>"
    },
    {
      id: 5,
      ...
      content: "<p>아인슈타인은 '복리'를 세계 8대 불가사의라고 불렀습니다. 매일 1%씩 좋아지면 1년 뒤에는 37배가 되지만, 매일 1%씩 나빠지면 0에 수렴하게 되죠. 투자의 세계에서도 마찬가지입니다. 하루 1%의 수익이 작아 보이지만, 그것이 10년, 20년 쌓이면 상상할 수 없는 자산이 됩니다. <div class='highlight-box'><strong>🚀 복리 3원칙</strong><br>1. 일찍 시작하라 (Time)<br>2. 수익을 재투자하라 (Reinvestment)<br>3. 잃지 마라 (Protection)</div><p>단타로 대박을 노리기보다, 꾸준한 우상향을 믿고 시간을 내 편으로 만드세요. 그것이 가장 확실한 부의 추월차선입니다.</p>"
    },
    {
      id: 4,
      ...
      content: "<p>장 시작 9시부터 9시 30분. 이 시간은 개미들의 무덤이자 도박장입니다. 급등주가 눈앞에서 번쩍거리면 이성이 마비되고 매수 버튼을 누르게 되죠. 이때 딱 3가지만 스스로에게 물어보세요. <ol><li>내가 지금 이 종목을 산 이유는 뉴스 때문인가, 분석 때문인가?</li><li>지금 사서 물리면 어디서 손절할 것인가?</li><li>오늘 지수가 하락장인가, 상승장인가?</li></ol><p>이 질문에 1초 만에 대답할 수 없다면, 그 매수는 100% 뇌동매매입니다.</p>"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content: "<p>주가는 결국 돈의 힘으로 움직입니다. 큰 돈을 굴리는 세력(기관, 외국인, 큰손)이 매집하는 종목은 언젠가 오를 수밖에 없습니다. 그렇다면 그들은 꼬리를 어떻게 숨길까요? <h4>시그널 1: 바닥권에서의 거래량 급증</h4><p>주가가 계속 하락하다가, 더 이상 떨어지지 않고 횡보하는데 갑자기 거래량이 평소의 5~10배 터진다면? 누군가 싼 가격에 주식을 쓸어담고 있다는 강력한 신호입니다. <h4>시그널 2: 윗꼬리 달린 양봉의 출현</h4><p>장중에는 급등했다가 종가에는 밀려서 끝나는 캔들을 '매집봉'이라고 부릅니다. 위에 물려있는 개미들의 물량을 소화해내며 테스트하는 과정이죠. 이 흔적을 발견했다면 당장 사는 것이 아니라, 관심 종목에 넣어두고 20일 이동평균선을 지지하는지 관찰해야 합니다.</p>"
    },
    {
      id: 1,
      ...
      content: "<p>많은 개인 투자자들이 겪는 미스터리가 있습니다. <em>'내가 안 사면 계속 오르다가, 참다 못해 사는 순간 귀신같이 떨어진다.'</em></p><p>시장에는 보이지 않는 CCTV라도 있는 걸까요? 아닙니다. 이것은 <strong>'거래량'</strong>과 <strong>'심리'</strong>의 상관관계 때문입니다. <h4>1. 뉴스가 나올 때는 이미 늦었다</h4><p>호재 뉴스가 메인에 걸리고, 옆자리 김 대리가 주식으로 돈을 벌었다고 자랑할 때가 언제일까요? 바로 세력들이 물량을 넘길 준비를 마쳤을 때입니다. 거래량이 터지며 양봉이 솟구칠 때, 우리는 흥분해서 매수 버튼을 누르지만, 스마트 머니는 그때 조용히 매도 버튼을 누릅니다. <div class='highlight-box'><strong>💡 탈출 솔루션</strong><br>모두가 환호할 때 오히려 두려워하고, 모두가 공포에 질려 던질 때 용기를 내세요. 차트상 거래량이 터진 장대양봉 추격 매수는 승률이 30% 미만입니다.</div><p>눌림목이 올 때까지 기다리는 인내심, 그것이 고수와 하수의 결정적 차이입니다.</p>"
    }
  ]
};
