...
조건:
1. **날짜 명시**: 반드시 "[YYYY년 MM월 DD일 시장 요약]"으로 시작할 것.
2. **객관적 사실만 기재**: 오늘 시장의 핵심 지표(코스피, 미국 지수, 환율, 거래량, 외국인/기관 수급 등)를 사실 그대로 전달할 것.
3. **주관적 의견/예측/경고 절대 금지**: "위험하다", "기회다", "심상찮다", "정신 차려야 한다", "녹록지 않다" 등 모든 주관적 표현 사용 금지.
4. **허용되는 표현**: "상승했습니다", "하락했습니다", "기록했습니다", "나타났습니다", "집계되었습니다" 등 사실 전달 표현만 사용.
5. 4~6문장 분량으로 간결하게 작성.
6. 1인칭 표현 절대 금지: "저", "제가", "나" 등 사용하지 말 것.
7. JSON 형식으로만 응답: {"brief": "[날짜] 내용..."}

예시 (좋은 표현):
- "[2026년 1월 26일 시장 요약] 코스피는 전일 대비 0.76% 상승한 4990.07로 마감했습니다."
